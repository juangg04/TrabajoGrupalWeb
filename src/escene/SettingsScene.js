export default class SettingsScene extends Phaser.Scene {
  ...
  create() {
    ...
    const background = this.add
      .sprite(400, 300, "frame0")
      .play("backgroundAnim");
    background.setDisplaySize(800, 600);

    const settingsText = this.add
      .text(400, 100, "Configuración", {
        fontSize: "32px",
        fill: "#fff",
        fontFamily: "Roboto",
      })
    ...
    const volumeText = this.add
      .text(400, 200, "Volumen de la Música", {
        fontSize: "24px",
        fill: "#fff",
        fontFamily: "Roboto",
      })
    ...
    const volumeSliderInteractive = this.add
      .rectangle(400, 250, 200, 20, 0xffffff, 0.5)
      .setInteractive();
